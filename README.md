...
```bash
git clone https://github.com/dellnoantechnp/RedisScanTask.git
cd RedisScanTask
...
Download the latest release from the [GitHub Releases page](https://github.com/dellnoantechnp/RedisScanTask/releases).
